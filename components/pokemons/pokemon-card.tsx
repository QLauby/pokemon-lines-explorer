...
import { PokemonStatus, getStatusInfo } from "@/lib/logos";
import { Pokemon, StatsModifiers } from "@/lib/types";
import { AttackManager } from "./pokemon-card/attack-manager";
import { HealthBar } from "./pokemon-card/health-bar";
import { PokemonCardAbilityItem } from "./pokemon-card/pokemon-card-ability-item";
import { PokemonCardHeader } from "./pokemon-card/pokemon-card-header";
import { PokemonCardTypes } from "./pokemon-card/pokemon-card-types";
import { StatsModifiersDisplay } from "./pokemon-card/stats-modifiers";
import { StatusSelector } from "./pokemon-card/status-selector";
